...
namespace NLayer.Web.Controllers
{
	public class ProductsController : Controller
	{
		...
		{
            return View(await _service.GetProductWithCategoryy());
		}
        ...
        {
            //update ve delete'de bizim hep birer id'ye ihtiyac var ve bu yüzden ürünlerimizi getbyId ile ilk cekmeliyiz
